...
import NoMangadex from '@/components/NoMangadex';
  ...
  return (
    <main className="min-h-screen flex flex-col items-center bg-[#2a2a2a] text-gray-100">
      ...
      {/* <GenreDropdown onChange={handleSelectionChange}/> */}
       <h1 className="text-3xl py-2 font-bold mb-4">Random Manga Finder</h1>
        ...
        {loading && (
          ...
          >
            <div className="flex flex-row">
              {/* Manga Image Loader */}
              <div className="bg-[#121212] shadow-md rounded p-6 w-full max-w-md flex flex-col items-center justify-center">
                <PulseLoader color="#000000" size={15} />
              </div>

              {/* Manga Synopsis Loader */}
              <div className="bg-[#121212] shadow-md rounded p-5 w-full max-w-md flex items-center justify-center">
